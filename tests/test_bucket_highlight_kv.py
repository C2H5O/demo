...
def bucket_config():
    ...
    return KVSamplingConfig(
        enabled=True, method="vda_role_bucket_highlight", retention_ratio=.625,
        key_frames=2, overlap_frames=8, new_frames=10,
        first_window_method="bucket_highlight", first_window_num_frames=16,
        first_window_num_buckets=16,
        bucket_highlight={"num_buckets": 6, "keep_policy": "fixed",
